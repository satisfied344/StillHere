...
(function () {
  ...
  var DICT = {
    ...
    /* ─────────── ABOUT PAGE ─────────── */
    'ab.hero.eyebrow':     { en: 'a quiet space, made on purpose',
                             ru: 'тихое место, сделанное намеренно' },
    ...
    'ab.hero.lede':        { en: 'we built this for the moments you don\'t know where to put, the heavy ones, and the bright ones too: a first kiss, a small win, a quiet grief. not a clinic, not a forum, a <em>small, soft place</em> on the internet where presence matters more than answers.',
                             ru: 'это место сделано для моментов, которым ты не знаешь, куда деться, тяжёлых, и светлых тоже: первый поцелуй, маленькая победа, тихое горе. не клиника, не форум, <em>маленькое и тихое место</em> в интернете, где просто <em>"побыть рядом"</em> важнее ответов.' },
    ...
    'ab.feat.01.label': { en: 'together',         ru: 'вместе' },
    ...
    'ab.feat.02.label': { en: 'company',         ru: 'рядом' },
    ...
    'ab.feat.03.label': { en: 'privacy',         ru: 'приватность' },
    ...
    'ct.hero.eyebrow':     { en: 'reach out, anytime',
                             ru: 'напиши нам в любое время' },
    ...
    'up.hero.eyebrow':     { en: 'changelog &amp; reflections',
                             ru: 'история изменений и заметки' },
    ...
    'pf.hero.eyebrow':     { en: 'your quiet corner',     ru: 'твой тихий уголок' },
    ...
    /* ── edit-profile.html ────────────────────────────────── */
    'ep.hero.eyebrow':     { en: 'settings, gently',       ru: 'настройки, без спешки' },
    ...
    'ep.about.label':      { en: 'about you',                    ru: 'о тебе' },
    ...
    'ep.pass.label':       { en: 'password',                     ru: 'пароль' },
    ...
    'ep.danger.label':     { en: 'danger zone',                  ru: 'опасная зона' },
    ...
    /* ── letters.html ────────────────────────────────────── */
    'ql.hero.eyebrow':     { en: 'things you couldn\'t say',
                             ru: 'то, что не сказал(а)' },
    ...
    /* ── preferences.html ────────────────────────────────── */
    'pref.hero.eyebrow':   { en: 'a quiet space, your way',
                             ru: 'тихое место, по-твоему' },
    ...
    'th.hero.eyebrow':     { en: 'talk to a real person',
                             ru: 'поговорить с настоящим' },
    ...
    /* ── create-post.html ────────────────────────────────── */
    'cp.hero.eyebrow':     { en: 'share, anonymously',     ru: 'поделись, анонимно' },
    'cp.hero.title':       { en: 'say it, <em>gently.</em>',          ru: 'скажи это, <em>мягко.</em>' },
    'cp.hero.lede':        { en: 'no perfect words, no need to wrap it up neatly. pain or joy, a heavy night or a quiet win, somebody out there knows <em>this exact feeling</em>, and seeing yours might be the reason they finally write theirs too.',
                             ru: 'не нужно идеальных слов, не надо писать красиво. боль или радость, тяжёлая ночь или тихая победа, кому-то знакомо <em>именно это чувство</em>, и твоя история может стать причиной, по которой он наконец напишет свою.' },
    ...
    'cp.c4.uphint':        { en: 'images or video, up to 25MB, max 6',
                             ru: 'фото или видео, до 25МБ, максимум 6' },
    ...
    'cp.topic.joy':        { en: 'joy',                               ru: 'радость' },
    'cp.topic.love':       { en: 'love',                              ru: 'любовь' },
    'cp.topic.relief':     { en: 'relief',                            ru: 'облегчение' },
    'cp.topic.hope':       { en: 'hope',                              ru: 'надежда' },
    'cp.topic.pride':      { en: 'pride',                             ru: 'гордость' },
    'cp.topic.envy':       { en: 'envy',                              ru: 'зависть' },
    ...
    /* ── statistics.html ────────────────────────────────── */
    'st.hero.eyebrow':     { en: 'the platform, transparently',
                             ru: 'платформа, прозрачно' },
    ...
    'dc.gl.eyebrow':       { en: 'community guidelines',   ru: 'правила сообщества' },
    ...
    'dc.pp.eyebrow':       { en: 'privacy policy',         ru: 'политика конфиденциальности' },
    ...
    'dc.tos.eyebrow':      { en: 'terms of service',       ru: 'условия использования' },
    ...
    'dc.cr.eyebrow':       { en: 'crisis resources',       ru: 'где найти помощь' },
    ...
    /* ── index.html (landing) ────────────────────────────── */
    'idx.hero.eyebrow':    { en: 'Presence, not solutions',
                             ru: 'Быть рядом, не решения' },
    ...
    'idx.hero.subtitle2':  { en: 'a hard day or a small joy, slow down,<br>breathe, and find a quiet place that <em>feels like yours.</em>',
                             ru: 'трудный день или маленькая радость, притормози,<br>дыши, и найди тихое место, которое <em>покажется твоим.</em>' },
    ...
    'idx.how.s1.title':    { en: 'write the real thing',  ru: 'напиши, что внутри' },
    ...
    'idx.c1.num':          { en: 'privacy',          ru: 'приватность' },
    ...
    'idx.c3.num':          { en: 'together',         ru: 'вместе' },
    ...
    'idx.c4.num':          { en: 'trust',            ru: 'доверие' },
    ...
    'idx.c5.num':          { en: 'human',            ru: 'человеческое' },
    ...
    'idx.join.eyebrow':    { en: 'invitation',       ru: 'приглашение' },
    ...
    /* ── coming-soon.html ──────────────────────────────── */
    'cs.eyebrow':          { en: 'still in the making',
                             ru: 'ещё в работе' },
    ...
    'cs.card1.num':        { en: 'language',         ru: 'язык' },
    ...
    'cs.card2.num':        { en: 'private chats',    ru: 'личные чаты' },
    ...
    'cs.card3.num':        { en: 'sessions',         ru: 'сессии' },
    ...
    'main.side.topic.joy':           { en: 'Joy',              ru: 'Радость' },
    'main.side.topic.love':          { en: 'Love',             ru: 'Любовь' },
    'main.side.topic.relief':        { en: 'Relief',           ru: 'Облегчение' },
    'main.side.topic.hope':          { en: 'Hope',             ru: 'Надежда' },
    'main.side.topic.pride':         { en: 'Pride',            ru: 'Гордость' },
    'main.side.topic.envy':          { en: 'Envy',             ru: 'Зависть' },
    ...
    'login.intro.eyebrow':       { en: 'welcome back',
                                   ru: 'с возвращением' },
    ...
    'reg.intro.eyebrow':         { en: 'new here',    ru: 'впервые здесь' },
